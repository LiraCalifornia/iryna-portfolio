  ...
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-0 py-20">
      ...
      <section className="mb-20">
        ...
        <p className="text-base leading-7 text-slate-700">
          There are three of us: two imperfect humans and one perfect dog — Marshal.
          Our home is the cozy, safe place that gives balance and strength. I’m
          deeply grateful to Lyubomyr for unwavering support.
        </p>
      </section>
      ...
      <section className="mb-20">
        ...
        <ul className="grid gap-4">
          ...
          <li className="rounded-2xl border border-slate-200 p-5">
            ...
            <p className="text-base leading-7 text-slate-700">
              The best work comes when you care like an owner. All-in or not at all.
            </p>
          </li>
        </ul>
      </section>
